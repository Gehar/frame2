...
namespace frame2
{
  ...
  public:
    ...
    typedef frame2::Msg<navstr::GloL2qBitsNum> MsgL2q;
    typedef frame2::Msg<navstr::GloL3ocBitsNum> MsgL3oc;
    typedef frame2::Msg<navstr::GloL1scBitsNum> MsgL1sc;
    typedef frame2::Msg<navstr::GloL2scBitsNum> MsgL2sc;
    ...
    //=========================================================================
    // l2q_obs
    inline bool has_l2q_obs() const;
    inline void clear_l2q_obs();
    inline const Obs& l2q_obs() const;
    inline Obs* mutable_l2q_obs();
    inline Obs* add_l2q_obs();

    // l2q_aux
    inline bool has_l2q_aux() const;
    inline void clear_l2q_aux();
    inline const Auxiliary& l2q_aux() const;
    inline Auxiliary* mutable_l2q_aux();
    inline Auxiliary* add_l2q_aux();

    // l2q_msg - Аномальные строки не поддерживаются
    inline bool has_l2q_msg() const;
    inline void clear_l2q_msg();
    inline const MsgL2q& l2q_msg() const;
    inline MsgL2q* mutable_l2q_msg();
    inline MsgL2q* add_l2q_msg();
    ...
    //=========================================================================
    // l1sc_obs
    inline bool has_l1sc_obs() const;
    inline void clear_l1sc_obs();
    inline const Obs& l1sc_obs() const;
    inline Obs* mutable_l1sc_obs();
    inline Obs* add_l1sc_obs();

    // l1sc_aux
    inline bool has_l1sc_aux() const;
    inline void clear_l1sc_aux();
    inline const Auxiliary& l1sc_aux() const;
    inline Auxiliary* mutable_l1sc_aux();
    inline Auxiliary* add_l1sc_aux();

    // l1sc_msg - Аномальные строки не поддерживаются
    inline bool has_l1sc_msg() const;
    inline void clear_l1sc_msg();
    inline const MsgL1sc& l1sc_msg() const;
    inline MsgL1sc* mutable_l1sc_msg();
    inline MsgL1sc* add_l1sc_msg();

    //=========================================================================
    // l2sc_obs
    inline bool has_l2sc_obs() const;
    inline void clear_l2sc_obs();
    inline const Obs& l2sc_obs() const;
    inline Obs* mutable_l2sc_obs();
    inline Obs* add_l2sc_obs();

    // l2sc_aux
    inline bool has_l2sc_aux() const;
    inline void clear_l2sc_aux();
    inline const Auxiliary& l2sc_aux() const;
    inline Auxiliary* mutable_l2sc_aux();
    inline Auxiliary* add_l2sc_aux();

    // l2sc_msg - Аномальные строки не поддерживаются
    inline bool has_l2sc_msg() const;
    inline void clear_l2sc_msg();
    inline const MsgL2sc& l2sc_msg() const;
    inline MsgL2sc* mutable_l2sc_msg();
    inline MsgL2sc* add_l2sc_msg();
  ...
  private:
    ...
    {
      enum c
      {/* 0-0x01, 1-x02, 2-x04, 3-x08, 4-x10, 5-x20, 6-x40, 7-x80, 8-x100, 9-x200 */
        L1OF = 0, L2OF,  L1OC,  L2Q,   L3OC,  L1CFG, L2CFG, SRL,   L1SC,   L2SC, MAX,
      };
    };
...
//    uint16_t mSetOfAuxFlags;
  ...
  // l2q
  inline bool
  Glo::has_l2q_obs () const
  {
    return (mSetOfObsFlags & Flag(Component::L2Q)) != 0;
  }
  inline void
  Glo::clear_l2q_obs ()
  {
    mSetOfObsFlags = mSetOfObsFlags & static_cast<uint16_t>(~Flag(Component::L2Q));
    mObs[Component::L2Q].Clear();
  }
  inline const Obs&
  Glo::l2q_obs () const
  {
    return mObs[Component::L2Q];
  }
  inline Obs*
  Glo::mutable_l2q_obs ()
  {
  ...
  {
    mObs[Component::L2Q].Clear();
    mSetOfObsFlags = mSetOfObsFlags | Flag(Component::L2Q);
    return &mObs[Component::L2Q];
  }

  // l2q_aux
  inline bool
  Glo::has_l2q_aux () const
  {
    return (mSetOfAuxFlags & Flag(Component::L2Q)) != 0;
  }
  inline void
  Glo::clear_l2q_aux ()
  {
    mSetOfAuxFlags = mSetOfAuxFlags & static_cast<uint16_t>(~Flag(Component::L2Q));
    mAux[Component::L2Q].Clear();
  }
  inline const Auxiliary&
  Glo::l2q_aux () const
  {
    return mAux[Component::L2Q];
  }
  inline Auxiliary*
  Glo::mutable_l2q_aux ()
  {
  ...
  {
    mAux[Component::L2Q].Clear();
    mSetOfAuxFlags = mSetOfAuxFlags | Flag(Component::L2Q);
    return &mAux[Component::L2Q];
  }

  // l2q_msg
  inline bool
  Glo::has_l2q_msg () const
  {
    return (mSetOfMsgFlags & Flag(Component::L2Q)) != 0;
  }
  inline void
  Glo::clear_l2q_msg ()
  {
    mSetOfMsgFlags = mSetOfMsgFlags & static_cast<uint16_t>(~Flag(Component::L2Q));
    mMsgL2q.Clear();
  }
  inline const Glo::MsgL2q&
  Glo::l2q_msg () const
  {
    return mMsgL2q;
  }
  ...
  {
    mMsgL2q.Clear();
    mSetOfMsgFlags = (mSetOfMsgFlags | Flag(Component::L2Q));
    return &mMsgL2q;
  }
  ...
  // l1sc
  inline bool
  Glo::has_l1sc_obs () const
  {
    return (mSetOfObsFlags & Flag(Component::L1SC)) != 0;
  }
  inline void
  Glo::clear_l1sc_obs ()
  {
    mSetOfObsFlags = mSetOfObsFlags & static_cast<uint16_t>(~Flag(Component::L1SC));
    mObs[Component::L1SC].Clear();
  }
  inline const Obs&
  Glo::l1sc_obs () const
  {
    return mObs[Component::L1SC];
  }
  inline Obs*
  Glo::mutable_l1sc_obs ()
  {
    return &mObs[Component::L1SC];
  }
  inline Obs*
  ...
  {
    mObs[Component::L1SC].Clear();
    mSetOfObsFlags = mSetOfObsFlags | Flag(Component::L1SC);
    return &mObs[Component::L1SC];
  }

  // l1sc_aux
  inline bool
  Glo::has_l1sc_aux () const
  {
    return (mSetOfAuxFlags & Flag(Component::L1SC)) != 0;
  }
  inline void
  Glo::clear_l1sc_aux ()
  {
    mSetOfAuxFlags = mSetOfAuxFlags & static_cast<uint16_t>(~Flag(Component::L1SC));
    mAux[Component::L1SC].Clear();
  }
  inline const Auxiliary&
  Glo::l1sc_aux () const
  {
    return mAux[Component::L1SC];
  }
  inline Auxiliary*
  Glo::mutable_l1sc_aux ()
  {
    return &mAux[Component::L1SC];
  }
  inline Auxiliary*
  ...
  {
    mAux[Component::L1SC].Clear();
    mSetOfAuxFlags = mSetOfAuxFlags | Flag(Component::L1SC);
    return &mAux[Component::L1SC];
  }

  // l1sc_msg
  inline bool
  Glo::has_l1sc_msg () const
  {
    return (mSetOfMsgFlags & Flag(Component::L1SC)) != 0;
  }
  inline void
  Glo::clear_l1sc_msg ()
  {
    mSetOfMsgFlags = mSetOfMsgFlags & static_cast<uint16_t>(~Flag(Component::L1SC));
    mMsgL1sc.Clear();
  }
  inline const Glo::MsgL1sc&
  Glo::l1sc_msg () const
  {
    return mMsgL1sc;
  }
  inline Glo::MsgL1sc*
  Glo::mutable_l1sc_msg ()
  {
    return &mMsgL1sc;
  }
  inline Glo::MsgL1sc*
  ...
  {
    mMsgL1sc.Clear();
    mSetOfMsgFlags = (mSetOfMsgFlags | Flag(Component::L1SC));
    return &mMsgL1sc;
  }
  ...
  // l2sc
  inline bool
  Glo::has_l2sc_obs () const
  {
    return (mSetOfObsFlags & Flag(Component::L2SC)) != 0;
  }
  inline void
  Glo::clear_l2sc_obs ()
  {
    mSetOfObsFlags = mSetOfObsFlags & static_cast<uint16_t>(~Flag(Component::L2SC));
    mObs[Component::L2SC].Clear();
  }
  inline const Obs&
  Glo::l2sc_obs () const
  {
    return mObs[Component::L2SC];
  }
  inline Obs*
  Glo::mutable_l2sc_obs ()
  {
    return &mObs[Component::L2SC];
  }
  inline Obs*
  ...
  {
    mObs[Component::L2SC].Clear();
    mSetOfObsFlags = mSetOfObsFlags | Flag(Component::L2SC);
    return &mObs[Component::L2SC];
  }

  // l2sc_aux
  inline bool
  Glo::has_l2sc_aux () const
  {
    return (mSetOfAuxFlags & Flag(Component::L2SC)) != 0;
  }
  inline void
  Glo::clear_l2sc_aux ()
  {
    mSetOfAuxFlags = mSetOfAuxFlags & static_cast<uint16_t>(~Flag(Component::L2SC));
    mAux[Component::L2SC].Clear();
  }
  inline const Auxiliary&
  Glo::l2sc_aux () const
  {
    return mAux[Component::L2SC];
  }
  inline Auxiliary*
  Glo::mutable_l2sc_aux ()
  {
    return &mAux[Component::L2SC];
  }
  inline Auxiliary*
  ...
  {
    mAux[Component::L2SC].Clear();
    mSetOfAuxFlags = mSetOfAuxFlags | Flag(Component::L2SC);
    return &mAux[Component::L2SC];
  }

  // l2sc_msg
  inline bool
  Glo::has_l2sc_msg () const
  {
    return (mSetOfMsgFlags & Flag(Component::L2SC)) != 0;
  }
  inline void
  Glo::clear_l2sc_msg ()
  {
    mSetOfMsgFlags = mSetOfMsgFlags & static_cast<uint16_t>(~Flag(Component::L2SC));
    mMsgL2sc.Clear();
  }
  inline const Glo::MsgL2sc&
  Glo::l2sc_msg () const
  {
    return mMsgL2sc;
  }
  inline Glo::MsgL2sc*
  Glo::mutable_l2sc_msg ()
  {
    return &mMsgL2sc;
  }
  inline Glo::MsgL2sc*
  ...
  {
    mMsgL2sc.Clear();
    mSetOfMsgFlags = (mSetOfMsgFlags | Flag(Component::L2SC));
    return &mMsgL2sc;
  }
