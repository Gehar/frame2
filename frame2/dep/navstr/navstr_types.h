...
namespace navstr
{
  ...
  constexpr size_t GloL2qBitsNum = 250;
  constexpr size_t GloL3ocBitsNum = 300;
  constexpr size_t GloL1scBitsNum = 250;
  constexpr size_t GloL2scBitsNum = 250;
  ...
  typedef navstr::NavStr<GloL2qBitsNum> GloL2q;
  typedef navstr::NavStr<GloL3ocBitsNum> GloL3oc;
  typedef navstr::NavStr<GloL1scBitsNum> GloL1sc;
  typedef navstr::NavStr<GloL2scBitsNum> GloL2sc;
